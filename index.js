...
var H = location.href.replace('background.html','');
...
if ('AutoPatchWorkCSS' in localStorage) {
...
function handleMessage(request, sender, sendResponse){
	...
	if (request.options) {
		openOrFocusTab('options_page.html');
		return;
	}
	...
	//sendResponse({date:timestamp.toLocaleString(),version:version});
}
